...
<head>
    ...
    <title>Административная панель редактирование опросного листа</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-3 aboutWrapper">
                    ...
                    <h4>Редактирование опросного листа: <?php echo $oprosItem['title_opros'];?></h4>
                    <div id="results"></div>
                    <form action="" method="post" id="specificationForm" enctype="multipart/form-data">
                        ...
                        <input  class="full form-control" type="text" name="title_opros" value="<?php echo $oprosItem['title_opros'];?>" placeholder="">

                        <label for="category_opros">Выберите категорию</label><br>
                        <select size="1" name="category_opros">
                            <option disabled>Выберите категорию</option>
                            <option <?php if ($oprosItem['category_opros'] =='kanal'){?>selected<?php }?>value="kanal">Канализация</option>
                            <option <?php if ($oprosItem['category_opros'] =='water'){?>selected<?php }?> value="water">Вода</option>
                            <option <?php if ($oprosItem['category_opros'] =='nafta'){?>selected<?php }?> value="nafta">Нафта</option>
                        </select><br><br>
                        <label for="file">Основное изображения</label><br>
                        <img src="/template/images/<?php echo $oprosItem['image_opros'];?>" alt="" width="200px">
                        <input type="file" name="file" value="<?php echo $oprosItem['image_opros'];?>"><br>
                        <label for="h1_opros">Заголовок</label><br>
                        <input  class="full form-control" type="text" name="h1_opros" value="<?php echo $oprosItem['h1_opros'];?>" placeholder="">

                        <label for="description_opros">Описание новости</label><br>
                        <input  class="full form-control" type="text" name="description_opros" value="<?php echo $oprosItem['description_opros'];?>" placeholder="">



                        <label for="content_opros">Контент</label><br>
                        <textarea name="content_opros"><?php echo $oprosItem['content_opros'];?></textarea><br>
                        <label for="status_opros">Опубликован:</label><br>
                        <input type="radio" <?php if ($oprosItem['status_opros'] =='1'){?>checked<?php }?> name="status_opros" value="1">Да
                        <input type="radio" <?php if ($oprosItem['status_opros'] =='0'){?>checked<?php }?> name="status_opros"  value="0">Нет <br><br>
