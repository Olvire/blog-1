...
<head>
    ...
    <title>Административная панель список сообщений с сайта</title>
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    <tr class="table_header">
                        ...
                        <td>Телефон</td>
                        <td>Сообщения</td>
                        <td>Тип/Имя/Температура/Давление</td>
                    </tr>
                    <?php foreach ($messageList as $messageItem) {?>
                        <tr>
                            <td><?php echo $messageItem['id'];?></td>
                            <td><?php echo $messageItem['date'];?></td>
                            <td><?php echo $messageItem['name_contacts'];?></td>
                            <td><?php echo $messageItem['email'];?></td>
                            <td><?php echo $messageItem['phone'];?></td>
                            <td><?php echo $messageItem['message'];?></td>
                            <td><?php echo $messageItem['oprosType'];?>/<?php echo $messageItem['oprosName'];?>/<?php echo $messageItem['oprosTemperature'];?>/<?php echo $messageItem['oprosPressure'];?></td>
                        </tr>
                    <?php } ?>
                </table>
