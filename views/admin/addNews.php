            ...
            <div class="row">
                <div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-3 aboutWrapper">
                    ...
                    <form action="" method="post" id="specificationForm" enctype="multipart/form-data">
                        ...
                        <input  class="full form-control" type="text" name="alias" value="" placeholder="">

                        <label for="title_Item">Title новости</label><br>
                        <input  class="full form-control" type="text" name="title_Item" value="" placeholder="">
                        <label for="file">Основное изображения</label><br>
                        <input type="file" name="file"><br>
                        <label for="h2_Item">Заголовок новости</label><br>
                        <input  class="full form-control" type="text" name="h2_Item" value="" placeholder="">

                        <label for="description_Item">Описание новости</label><br>
                        <input  class="full form-control" type="text" name="description_Item" value="" placeholder="">

                        <label for="content_Item">Краткое содержание новости</label><br>
                        <input  class="full form-control" type="text" name="content_Item" value="" placeholder="">

                        <label for="long_content">Содержание новости</label><br>
                        <textarea name="long_content"></textarea><br>
                        <label for="status">Опубликован:</label><br>
                        <input type="radio" checked name="status" value="1">Да
                        <input type="radio" name="status"  value="0">Нет <br><br>
