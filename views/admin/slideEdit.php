...
<head>
    ...
    <title>Административная панель редактирование слайда</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-3 aboutWrapper">
                    ...
                    <h4>Редактирование слайда: <?php echo $slideById['title_slide'];?></h4>
                    <div id="results"></div>
                    <form action="" method="post" id="specificationForm" enctype="multipart/form-data">
                        <label for="title_slide">Заголовок</label><br>
                        <input  class="full form-control" type="text" name="title_slide" value="<?php echo $slideById['title_slide'];?>" placeholder="">

                        <label for="description_slide">Описание</label><br>
                        <input  class="full form-control" type="text" name="description_slide" value="<?php echo $slideById['description_slide'];?>" placeholder="">

                        <label for="image_first">Изображение</label><br>
                        <img src="/template/img/<?php echo $slideById['image_first'];?>" alt="" width="50px"><br><br>
                        <input type="file" name="image_first" value="<?php echo $slideById['image_first'];?>"><br>
