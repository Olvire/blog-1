    ...
    <div class="about-background">
        <div class="container">
            <div class="row">
                ...
                <a href="/admin/addNews" class="btn btn-danger">Добавить новость</a><br><br>
                <table class="table table-bordered">
                    <tr class="table_header">
                        <td>ID</td>
                        <td>Названия новости</td>
                        <td>Управления</td>
                    </tr>
                    <?php foreach ($newsList as $newsItem) {?>
                    <tr>
                        <td><?php echo $newsItem['id'];?></td>
                        <td><?php echo $newsItem['title_Item'];?></td>
                        <td><a href="/admin/news/edit/<?php echo $newsItem['id'];?>">РЕДАКТИРОВАТЬ/</a><a href="/admin/deleteNews/<?php echo $newsItem['id'];?>">УДАЛИТЬ</a></td>
                    </tr>
                    <?php } ?>
                </table>
